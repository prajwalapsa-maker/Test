...
app.listen(PORT, () => {
  console.log(`🚀 Universal File Explorer running on http://localhost:${PORT}`);
  console.log('📁 Supports ALL file types:');
  console.log('  📝 Text: TXT, CSV, JSON, XML, HTML, CSS, JS, MD, LOG, INI, CFG');
  console.log('  🖼️ Images: JPG, PNG, GIF, BMP, WebP, SVG, ICO');
  console.log('  📊 Documents: XLSX, XLS, DOCX, DOC, PDF, PPTX, PPT');
  console.log('  🎵 Audio: MP3, WAV, FLAC, AAC, OGG');
  console.log('  🎬 Video: MP4, AVI, MKV, MOV, WMV, FLV');
  console.log('  💻 Code: HTML, CSS, JS, PHP, PY, JAVA, CPP, C, SQL');
  console.log('  🗜️ Archives: ZIP, RAR, 7Z, TAR, GZ');
  console.log('  ⚙️ System: EXE, MSI, DMG, ISO');
